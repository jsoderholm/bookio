...
const Sidebar = () => {
  return (
    <aside className="sticky inset-y-0 left-0 z-10 flex-col hidden w-24 h-screen pb-4 border-r bg-neutral sm:flex">
      <div className="flex items-center justify-center aspect-square">
        <img src="/logo.svg" alt="Acme Inc" className="w-12" />
      </div>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Link
              ...
              activeProps={{ className: "text-primary bg-white border" }}
            >
