...
const Sidebar = () => {
  return (
    <aside className="sticky inset-y-0 left-0 z-10 flex-col hidden w-20 h-screen pb-4 border-r bg-neutral dark:bg-background sm:flex">
      <div className="flex items-center justify-center aspect-square">
        <img src="/logo-small.svg" alt="Acme Inc" className="w-11" />
      </div>
